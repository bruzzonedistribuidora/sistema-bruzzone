...
// --- COMPONENTE INTERNO: TARJETA DE PRODUCTO (Movido arriba para evitar errores de hoisting) ---
            ...
            <main className="flex-1 p-6 space-y-8 overflow-y-auto custom-scrollbar">
                ...
                {currentView === 'CART' && (
                    <div className="space-y-6 animate-fade-in pb-10">
                        ...
                        <div className="space-y-3">
                            {cart.map((item, idx) => (
                                <div key={idx} className="bg-white p-4 rounded-[2rem] border border-slate-200 flex justify-between items-center shadow-sm">
                                    <div className="flex items-center gap-3 min-w-0">
