                          ...
                          {importStep === 3 && (
                              <div className="flex flex-col items-center justify-center h-full gap-4">
                                  <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center text-green-600 mb-2">
                                      {/* Updated usage of the local check icon */}
                                      <CheckIconLocal size={40}/>
                                  </div>
...
// Simple Tag Icon component for internal use, renamed to avoid conflict with lucide-react import
const CheckIconLocal = ({size}: {size:number}) => (
