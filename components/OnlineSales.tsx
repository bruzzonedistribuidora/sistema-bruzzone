...
// Helper for Mock Data - Added missing appliedPrice property
                          ...
                          >
                              ...
                              <div className="text-right">
                                  ...
                                  <div className="flex gap-1 justify-end mt-2">
                                      {/* Wrapped icons in span to handle tooltips correctly without using unsupported prop */}
                                      {order.invoiced && <span title="Facturado"><FileText size={14} className="text-green-500"/></span>}
                                      {order.labelPrinted && <span title="Etiqueta Impresa"><Printer size={14} className="text-blue-500"/></span>}
                                  </div>
                              </div>
                          </div>
                      ))
