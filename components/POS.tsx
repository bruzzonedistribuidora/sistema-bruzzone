...
const POS: React.FC = () => {
  ...
  useEffect(() => {
      if (isEditModalOpen && editingProduct) {
          ...
          setEditingProduct((prev: Product | null) => prev ? ({ ...prev, costAfterDiscounts: parseFloat(cost.toFixed(2)), priceNeto: parseFloat(priceNeto.toFixed(2)), priceFinal: parseFloat(priceFinal.toFixed(2)) }) : null);
      }
