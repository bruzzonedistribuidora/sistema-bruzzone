            ...
            <div className="p-6 bg-slate-50 border-b grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                ...
                <div className="md:col-span-8 relative">
                    ...
                    <div className="relative">
                        ...
                        <input type="text" placeholder="SKU o Nombre..." className="w-full pl-10 pr-4 py-2 bg-white border rounded-lg outline-none uppercase font-bold text-sm" value={searchTerm} onChange={e => { setSearchTerm(e.target.value); setShowSearchResults(true); }} onFocus={() => setShowSearchResults(true)} />
                    </div>
                            ...
                            {filteredProducts.map(p => (
                                <button key={p.id} onClick={() => addToCart(p)} className="w-full text-left px-4 py-3 hover:bg-indigo-50 border-b last:border-0 border-gray-50 flex justify-between items-center group">
                                    <div className="text-sm">
                                        ...
                                        <div className="text-[10px] text-gray-400 font-mono">{p.internalCodes[0]}</div>
                                    </div>
